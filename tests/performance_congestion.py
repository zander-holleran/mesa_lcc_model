...
Usage:
    python tests/performance_congestion.py
...
def run_performance_test(
    ...
    if verbose:
        ...
        print("=" * 60)
        print(f"Config: 3000 persons, 3 days, traffic_percentile=90")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run congestion performance test")
